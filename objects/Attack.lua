...
function Attack:draw()
	...
	if self.attack == "Spread" or self.attack == "Rapid" then
	...
	love.graphics.print(
		attacks[self.attack].abbreviation,
		self.x,
		self.y,
		0,
		1,
...
function Attack:die()
	...
	self.area:addGameObject(
		"InfoText",
		self.x + table.random({ -1, 1 }) * self.w,
		self.y + table.random({ -1, 1 }) * self.h,
		{ color = default_color, text = self.attack }
	)
end
