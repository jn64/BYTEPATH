...
case_error(
	...
	"./ser.lua:29: Trying to serialize unsupported type thread",
	"unsupported type"
)

case(
	{ "a", foo = "bar", ["3f"] = true, _1 = false, ["00"] = 9 },
	'return {"a",["3f"]=true,_1=false,["00"]=9,foo="bar"}',
	"various"
)

case(
	{ "\127\230\255\254\128\12\0128\n\31" },
	'return {"\\127\\230\\255\\254\\128\\12\\0128\\n\\31"}',
	"non-ASCII or control characters in string value"
)

case(
	{ ["\127\230\255\254\128\12\0128\n\31"] = "\0" },
	'return {["\\127\\230\\255\\254\\128\\12\\0128\\n\\31"]="\\0"}',
	"non-ASCII or control characters in string key"
)
