...
if steamworks.client_ptr == nil then
	error("SteamClient() returns NULL")
end
...
if steamworks.unifiedmessages_ptr == nil then
	...
	function steamworks.unifiedmessages.GetMethodResponseInfo(hHandle, punResponseSize, peResult)
		return lib.SteamAPI_ISteamUnifiedMessages_GetMethodResponseInfo(
			steamworks.unifiedmessages_ptr,
			hHandle,
			punResponseSize,
			peResult
	...
	function steamworks.unifiedmessages.GetMethodResponseData(
		hHandle,
		pResponseBuffer,
	...
	function steamworks.unifiedmessages.SendNotification(
...
steamworks.friends = {}
steamworks.friends_ptr = lib.SteamAPI_ISteamClient_GetISteamFriends(
	steamworks.client_ptr,
	steamworks.steam_user_ptr,
	steamworks.pipe_ptr,
	"SteamFriends015"
...
if steamworks.friends_ptr == nil then
	...
	function steamworks.friends.GetFriendPersonaNameHistory(steamIDFriend, iPersonaName)
		local str =
			lib.SteamAPI_ISteamFriends_GetFriendPersonaNameHistory(steamworks.friends_ptr, steamIDFriend, iPersonaName)
		if str ~= nil then
			return ffi.string(str)
		end
	end
	...
	function steamworks.friends.GetFriendsGroupMembersList(friendsGroupID, pOutSteamIDMembers, nMembersCount)
		return lib.SteamAPI_ISteamFriends_GetFriendsGroupMembersList(
	...
	function steamworks.friends.GetClanActivityCounts(steamIDClan, pnOnline, pnInGame, pnChatting)
		return lib.SteamAPI_ISteamFriends_GetClanActivityCounts(
			steamworks.friends_ptr,
			steamIDClan,
			pnOnline,
			pnInGame,
	...
	function steamworks.friends.DownloadClanActivityCounts(psteamIDClans, cClansToRequest)
		return lib.SteamAPI_ISteamFriends_DownloadClanActivityCounts(
			steamworks.friends_ptr,
			psteamIDClans,
			cClansToRequest
		)
	...
	function steamworks.friends.GetFriendRichPresenceKeyByIndex(steamIDFriend, iKey)
		local str =
			lib.SteamAPI_ISteamFriends_GetFriendRichPresenceKeyByIndex(steamworks.friends_ptr, steamIDFriend, iKey)
		if str ~= nil then
			return ffi.string(str)
		end
	end
	...
	function steamworks.friends.GetFriendMessage(steamIDFriend, iMessageID, pvData, cubData, peChatEntryType)
		return lib.SteamAPI_ISteamFriends_GetFriendMessage(
			steamworks.friends_ptr,
			steamIDFriend,
			iMessageID,
			pvData,
...
steamworks.networking_ptr = lib.SteamAPI_ISteamClient_GetISteamNetworking(
	steamworks.client_ptr,
	steamworks.steam_user_ptr,
	steamworks.pipe_ptr,
	"SteamNetworking005"
...
if steamworks.networking_ptr == nil then
	...
	function steamworks.networking.SendP2PPacket(steamIDRemote, pubData, cubData, eP2PSendType, nChannel)
		return lib.SteamAPI_ISteamNetworking_SendP2PPacket(
	...
	function steamworks.networking.ReadP2PPacket(pubDest, cubDest, pcubMsgSize, psteamIDRemote, nChannel)
		return lib.SteamAPI_ISteamNetworking_ReadP2PPacket(
			steamworks.networking_ptr,
			pubDest,
			cubDest,
			pcubMsgSize,
	...
	function steamworks.networking.GetP2PSessionState(steamIDRemote, pConnectionState)
		return lib.SteamAPI_ISteamNetworking_GetP2PSessionState(
			steamworks.networking_ptr,
			steamIDRemote,
			pConnectionState
		)
	...
	function steamworks.networking.CreateListenSocket(nVirtualP2PPort, nIP, nPort, bAllowUseOfPacketRelay)
		return lib.SteamAPI_ISteamNetworking_CreateListenSocket(
			steamworks.networking_ptr,
			nVirtualP2PPort,
			nIP,
			nPort,
	...
	function steamworks.networking.CreateP2PConnectionSocket(
		steamIDTarget,
		nVirtualPort,
		nTimeoutSec,
		bAllowUseOfPacketRelay
	)
		return lib.SteamAPI_ISteamNetworking_CreateP2PConnectionSocket(
			steamworks.networking_ptr,
			steamIDTarget,
			nVirtualPort,
			nTimeoutSec,
	...
	function steamworks.networking.SendDataOnSocket(hSocket, pubData, cubData, bReliable)
		return lib.SteamAPI_ISteamNetworking_SendDataOnSocket(
			steamworks.networking_ptr,
			hSocket,
			pubData,
			cubData,
	...
	function steamworks.networking.RetrieveDataFromSocket(hSocket, pubDest, cubDest, pcubMsgSize)
		return lib.SteamAPI_ISteamNetworking_RetrieveDataFromSocket(
			steamworks.networking_ptr,
			hSocket,
			pubDest,
			cubDest,
	...
	function steamworks.networking.IsDataAvailable(hListenSocket, pcubMsgSize, phSocket)
		return lib.SteamAPI_ISteamNetworking_IsDataAvailable(
			steamworks.networking_ptr,
			hListenSocket,
			pcubMsgSize,
			phSocket
	...
	function steamworks.networking.RetrieveData(hListenSocket, pubDest, cubDest, pcubMsgSize, phSocket)
		return lib.SteamAPI_ISteamNetworking_RetrieveData(
			steamworks.networking_ptr,
			hListenSocket,
			pubDest,
			cubDest,
...
steamworks.controller_ptr = lib.SteamAPI_ISteamClient_GetISteamController(
	steamworks.client_ptr,
	steamworks.steam_user_ptr,
	steamworks.pipe_ptr,
	"SteamController005"
...
if steamworks.controller_ptr == nil then
	...
	function steamworks.controller.ActivateActionSet(controllerHandle, actionSetHandle)
		return lib.SteamAPI_ISteamController_ActivateActionSet(
	...
	function steamworks.controller.GetDigitalActionData(controllerHandle, digitalActionHandle)
		return lib.SteamAPI_ISteamController_GetDigitalActionData(
			steamworks.controller_ptr,
			controllerHandle,
			digitalActionHandle
		)
	end
	function steamworks.controller.GetDigitalActionOrigins(
		controllerHandle,
		actionSetHandle,
		digitalActionHandle,
		originsOut
	...
	function steamworks.controller.GetAnalogActionData(controllerHandle, analogActionHandle)
		return lib.SteamAPI_ISteamController_GetAnalogActionData(
			steamworks.controller_ptr,
			controllerHandle,
			analogActionHandle
		)
	end
	function steamworks.controller.GetAnalogActionOrigins(
		controllerHandle,
		actionSetHandle,
		analogActionHandle,
		originsOut
	...
	function steamworks.controller.StopAnalogActionMomentum(controllerHandle, eAction)
		return lib.SteamAPI_ISteamController_StopAnalogActionMomentum(
			steamworks.controller_ptr,
			controllerHandle,
			eAction
		)
	...
	function steamworks.controller.TriggerHapticPulse(controllerHandle, eTargetPad, usDurationMicroSec)
		return lib.SteamAPI_ISteamController_TriggerHapticPulse(
			steamworks.controller_ptr,
			controllerHandle,
			eTargetPad,
			usDurationMicroSec
	...
	function steamworks.controller.TriggerRepeatedHapticPulse(
		controllerHandle,
		eTargetPad,
		usDurationMicroSec,
		usOffMicroSec,
	...
	function steamworks.controller.TriggerVibration(controllerHandle, usLeftSpeed, usRightSpeed)
		return lib.SteamAPI_ISteamController_TriggerVibration(
			steamworks.controller_ptr,
			controllerHandle,
			usLeftSpeed,
			usRightSpeed
	...
	function steamworks.controller.SetLEDColor(controllerHandle, nColorR, nColorG, nColorB, nFlags)
		return lib.SteamAPI_ISteamController_SetLEDColor(
			steamworks.controller_ptr,
			controllerHandle,
			nColorR,
			nColorG,
	...
	function steamworks.controller.ShowDigitalActionOrigins(
		controllerHandle,
		digitalActionHandle,
		flScale,
		flXPosition,
	...
	function steamworks.controller.ShowAnalogActionOrigins(
		controllerHandle,
		analogActionHandle,
		flScale,
		flXPosition,
...
if steamworks.matchmakingservers_ptr == nil then
	...
	function steamworks.matchmakingservers.RequestInternetServerList(
		iApp,
		ppchFilters,
		nFilters,
		pRequestServersResponse
	)
		return lib.SteamAPI_ISteamMatchmakingServers_RequestInternetServerList(
			steamworks.matchmakingservers_ptr,
			iApp,
			ppchFilters,
			nFilters,
			pRequestServersResponse
	...
	function steamworks.matchmakingservers.RequestLANServerList(iApp, pRequestServersResponse)
		return lib.SteamAPI_ISteamMatchmakingServers_RequestLANServerList(
			steamworks.matchmakingservers_ptr,
			iApp,
			pRequestServersResponse
		)
	end
	function steamworks.matchmakingservers.RequestFriendsServerList(
		iApp,
		ppchFilters,
		nFilters,
		pRequestServersResponse
	)
		return lib.SteamAPI_ISteamMatchmakingServers_RequestFriendsServerList(
			steamworks.matchmakingservers_ptr,
			iApp,
			ppchFilters,
			nFilters,
	...
	function steamworks.matchmakingservers.RequestFavoritesServerList(
		iApp,
		ppchFilters,
		nFilters,
		pRequestServersResponse
	)
		return lib.SteamAPI_ISteamMatchmakingServers_RequestFavoritesServerList(
			steamworks.matchmakingservers_ptr,
			iApp,
			ppchFilters,
			nFilters,
	...
	function steamworks.matchmakingservers.RequestHistoryServerList(
		iApp,
		ppchFilters,
		nFilters,
		pRequestServersResponse
	)
		return lib.SteamAPI_ISteamMatchmakingServers_RequestHistoryServerList(
			steamworks.matchmakingservers_ptr,
			iApp,
			ppchFilters,
			nFilters,
	...
	function steamworks.matchmakingservers.RequestSpectatorServerList(
		iApp,
		ppchFilters,
		nFilters,
		pRequestServersResponse
	)
		return lib.SteamAPI_ISteamMatchmakingServers_RequestSpectatorServerList(
			steamworks.matchmakingservers_ptr,
			iApp,
			ppchFilters,
			nFilters,
	...
	function steamworks.matchmakingservers.ReleaseRequest(hServerListRequest)
		return lib.SteamAPI_ISteamMatchmakingServers_ReleaseRequest(
			steamworks.matchmakingservers_ptr,
			hServerListRequest
		)
	end
	function steamworks.matchmakingservers.GetServerDetails(hRequest, iServer)
		return lib.SteamAPI_ISteamMatchmakingServers_GetServerDetails(
			steamworks.matchmakingservers_ptr,
			hRequest,
			iServer
		)
	...
	function steamworks.matchmakingservers.PingServer(unIP, usPort, pRequestServersResponse)
		return lib.SteamAPI_ISteamMatchmakingServers_PingServer(
			steamworks.matchmakingservers_ptr,
			unIP,
			usPort,
			pRequestServersResponse
	...
	function steamworks.matchmakingservers.PlayerDetails(unIP, usPort, pRequestServersResponse)
		return lib.SteamAPI_ISteamMatchmakingServers_PlayerDetails(
			steamworks.matchmakingservers_ptr,
			unIP,
			usPort,
			pRequestServersResponse
	...
	function steamworks.matchmakingservers.ServerRules(unIP, usPort, pRequestServersResponse)
		return lib.SteamAPI_ISteamMatchmakingServers_ServerRules(
			steamworks.matchmakingservers_ptr,
			unIP,
			usPort,
			pRequestServersResponse
...
if steamworks.userstats_ptr == nil then
	...
	function steamworks.userstats.UpdateAvgRateStat(pchName, flCountThisSession, dSessionLength)
		return lib.SteamAPI_ISteamUserStats_UpdateAvgRateStat(
	...
	function steamworks.userstats.GetAchievementAndUnlockTime(pchName, pbAchieved, punUnlockTime)
		return lib.SteamAPI_ISteamUserStats_GetAchievementAndUnlockTime(
			steamworks.userstats_ptr,
			pchName,
			pbAchieved,
			punUnlockTime
	...
	function steamworks.userstats.GetAchievementDisplayAttribute(pchName, pchKey)
		local str =
			lib.SteamAPI_ISteamUserStats_GetAchievementDisplayAttribute(steamworks.userstats_ptr, pchName, pchKey)
		if str ~= nil then
			return ffi.string(str)
		end
	end
	function steamworks.userstats.IndicateAchievementProgress(pchName, nCurProgress, nMaxProgress)
		return lib.SteamAPI_ISteamUserStats_IndicateAchievementProgress(
			steamworks.userstats_ptr,
			pchName,
			nCurProgress,
			nMaxProgress
	...
	function steamworks.userstats.GetUserAchievement(steamIDUser, pchName, pbAchieved)
		return lib.SteamAPI_ISteamUserStats_GetUserAchievement(
			steamworks.userstats_ptr,
			steamIDUser,
			pchName,
			pbAchieved
	...
	function steamworks.userstats.GetUserAchievementAndUnlockTime(steamIDUser, pchName, pbAchieved, punUnlockTime)
		return lib.SteamAPI_ISteamUserStats_GetUserAchievementAndUnlockTime(
			steamworks.userstats_ptr,
			steamIDUser,
			pchName,
			pbAchieved,
	...
	function steamworks.userstats.FindOrCreateLeaderboard(
		pchLeaderboardName,
	...
	function steamworks.userstats.DownloadLeaderboardEntries(
		hSteamLeaderboard,
	...
	function steamworks.userstats.DownloadLeaderboardEntriesForUsers(hSteamLeaderboard, prgUsers, cUsers)
		return lib.SteamAPI_ISteamUserStats_DownloadLeaderboardEntriesForUsers(
			steamworks.userstats_ptr,
			hSteamLeaderboard,
			prgUsers,
			cUsers
	...
	function steamworks.userstats.GetDownloadedLeaderboardEntry(
	...
	function steamworks.userstats.GetMostAchievedAchievementInfo(pchName, unNameBufLen, pflPercent, pbAchieved)
		return lib.SteamAPI_ISteamUserStats_GetMostAchievedAchievementInfo(
			steamworks.userstats_ptr,
			pchName,
			unNameBufLen,
			pflPercent,
	...
	function steamworks.userstats.GetNextMostAchievedAchievementInfo(
		iIteratorPrevious,
		pchName,
		unNameBufLen,
		pflPercent,
		...
		return lib.SteamAPI_ISteamUserStats_GetNextMostAchievedAchievementInfo(
			steamworks.userstats_ptr,
			iIteratorPrevious,
			pchName,
			unNameBufLen,
...
if steamworks.htmlsurface_ptr == nil then
	...
	function steamworks.htmlsurface.MouseDoubleClick(unBrowserHandle, eMouseButton)
		return lib.SteamAPI_ISteamHTMLSurface_MouseDoubleClick(
	...
	function steamworks.htmlsurface.KeyDown(unBrowserHandle, nNativeKeyCode, eHTMLKeyModifiers)
		return lib.SteamAPI_ISteamHTMLSurface_KeyDown(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
			nNativeKeyCode,
			eHTMLKeyModifiers
	...
	function steamworks.htmlsurface.KeyUp(unBrowserHandle, nNativeKeyCode, eHTMLKeyModifiers)
		return lib.SteamAPI_ISteamHTMLSurface_KeyUp(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
			nNativeKeyCode,
			eHTMLKeyModifiers
	...
	function steamworks.htmlsurface.KeyChar(unBrowserHandle, cUnicodeChar, eHTMLKeyModifiers)
		return lib.SteamAPI_ISteamHTMLSurface_KeyChar(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
			cUnicodeChar,
			eHTMLKeyModifiers
	...
	function steamworks.htmlsurface.SetHorizontalScroll(unBrowserHandle, nAbsolutePixelScroll)
		return lib.SteamAPI_ISteamHTMLSurface_SetHorizontalScroll(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
	...
	function steamworks.htmlsurface.SetVerticalScroll(unBrowserHandle, nAbsolutePixelScroll)
		return lib.SteamAPI_ISteamHTMLSurface_SetVerticalScroll(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
			nAbsolutePixelScroll
		)
	...
	function steamworks.htmlsurface.Find(unBrowserHandle, pchSearchStr, bCurrentlyInFind, bReverse)
		return lib.SteamAPI_ISteamHTMLSurface_Find(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
			pchSearchStr,
			bCurrentlyInFind,
	...
	function steamworks.htmlsurface.SetPageScaleFactor(unBrowserHandle, flZoom, nPointX, nPointY)
		return lib.SteamAPI_ISteamHTMLSurface_SetPageScaleFactor(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
			flZoom,
			nPointX,
	...
	function steamworks.htmlsurface.SetBackgroundMode(unBrowserHandle, bBackgroundMode)
		return lib.SteamAPI_ISteamHTMLSurface_SetBackgroundMode(
			steamworks.htmlsurface_ptr,
			unBrowserHandle,
			bBackgroundMode
		)
...
if steamworks.screenshots_ptr == nil then
	...
	function steamworks.screenshots.WriteScreenshot(pubRGB, cubRGB, nWidth, nHeight)
		return lib.SteamAPI_ISteamScreenshots_WriteScreenshot(
			steamworks.screenshots_ptr,
			pubRGB,
			cubRGB,
			nWidth,
			nHeight
	...
	function steamworks.screenshots.AddScreenshotToLibrary(pchFilename, pchThumbnailFilename, nWidth, nHeight)
		return lib.SteamAPI_ISteamScreenshots_AddScreenshotToLibrary(
			steamworks.screenshots_ptr,
			pchFilename,
	...
	function steamworks.screenshots.TagPublishedFile(hScreenshot, unPublishedFileID)
		return lib.SteamAPI_ISteamScreenshots_TagPublishedFile(
			steamworks.screenshots_ptr,
			hScreenshot,
			unPublishedFileID
		)
	...
	function steamworks.screenshots.AddVRScreenshotToLibrary(eType, pchFilename, pchVRFilename)
		return lib.SteamAPI_ISteamScreenshots_AddVRScreenshotToLibrary(
			steamworks.screenshots_ptr,
			eType,
			pchFilename,
			pchVRFilename
...
if steamworks.ugc_ptr == nil then
	...
	function steamworks.ugc.CreateQueryUGCDetailsRequest(pvecPublishedFileID, unNumPublishedFileIDs)
		return lib.SteamAPI_ISteamUGC_CreateQueryUGCDetailsRequest(
			steamworks.ugc_ptr,
			pvecPublishedFileID,
	...
	function steamworks.ugc.GetQueryUGCMetadata(handle, index, pchMetadata, cchMetadatasize)
		return lib.SteamAPI_ISteamUGC_GetQueryUGCMetadata(
			steamworks.ugc_ptr,
			handle,
			index,
			pchMetadata,
	...
	function steamworks.ugc.GetQueryUGCChildren(handle, index, pvecPublishedFileID, cMaxEntries)
		return lib.SteamAPI_ISteamUGC_GetQueryUGCChildren(
			steamworks.ugc_ptr,
			handle,
			index,
			pvecPublishedFileID,
	...
	function steamworks.ugc.GetQueryUGCKeyValueTag(
		handle,
		index,
		keyValueTagIndex,
		pchKey,
	...
	function steamworks.ugc.GetItemUpdateProgress(handle, punBytesProcessed, punBytesTotal)
		return lib.SteamAPI_ISteamUGC_GetItemUpdateProgress(
			steamworks.ugc_ptr,
			handle,
			punBytesProcessed,
			punBytesTotal
	...
	function steamworks.ugc.GetItemInstallInfo(nPublishedFileID, punSizeOnDisk, pchFolder, cchFolderSize, punTimeStamp)
		return lib.SteamAPI_ISteamUGC_GetItemInstallInfo(
			steamworks.ugc_ptr,
			nPublishedFileID,
			punSizeOnDisk,
			pchFolder,
	...
	function steamworks.ugc.GetItemDownloadInfo(nPublishedFileID, punBytesDownloaded, punBytesTotal)
		return lib.SteamAPI_ISteamUGC_GetItemDownloadInfo(
			steamworks.ugc_ptr,
			nPublishedFileID,
			punBytesDownloaded,
			punBytesTotal
	...
	function steamworks.ugc.StartPlaytimeTracking(pvecPublishedFileID, unNumPublishedFileIDs)
		return lib.SteamAPI_ISteamUGC_StartPlaytimeTracking(
			steamworks.ugc_ptr,
			pvecPublishedFileID,
			unNumPublishedFileIDs
		)
	...
	function steamworks.ugc.StopPlaytimeTracking(pvecPublishedFileID, unNumPublishedFileIDs)
		return lib.SteamAPI_ISteamUGC_StopPlaytimeTracking(
			steamworks.ugc_ptr,
			pvecPublishedFileID,
			unNumPublishedFileIDs
		)
	...
	function steamworks.ugc.RemoveDependency(nParentPublishedFileID, nChildPublishedFileID)
		return lib.SteamAPI_ISteamUGC_RemoveDependency(
			steamworks.ugc_ptr,
...
if steamworks.apps_ptr == nil then
	...
	function steamworks.apps.BGetDLCDataByIndex(iDLC, pAppID, pbAvailable, pchName, cchNameBufferSize)
		return lib.SteamAPI_ISteamApps_BGetDLCDataByIndex(
			steamworks.apps_ptr,
			iDLC,
			pAppID,
			pbAvailable,
	...
	function steamworks.apps.GetDlcDownloadProgress(nAppID, punBytesDownloaded, punBytesTotal)
		return lib.SteamAPI_ISteamApps_GetDlcDownloadProgress(
			steamworks.apps_ptr,
			nAppID,
			punBytesDownloaded,
			punBytesTotal
...
if steamworks.inventory_ptr == nil then
	...
	function steamworks.inventory.GetResultItems(resultHandle, pOutItemsArray, punOutItemsArraySize)
		return lib.SteamAPI_ISteamInventory_GetResultItems(
	...
	function steamworks.inventory.GetResultItemProperty(
		resultHandle,
		unItemIndex,
		pchPropertyName,
		pchValueBuffer,
	...
	function steamworks.inventory.GetItemsByID(pResultHandle, pInstanceIDs, unCountInstanceIDs)
		return lib.SteamAPI_ISteamInventory_GetItemsByID(
			steamworks.inventory_ptr,
			pResultHandle,
			pInstanceIDs,
			unCountInstanceIDs
	...
	function steamworks.inventory.SerializeResult(resultHandle, pOutBuffer, punOutBufferSize)
		return lib.SteamAPI_ISteamInventory_SerializeResult(
			steamworks.inventory_ptr,
			resultHandle,
			pOutBuffer,
			punOutBufferSize
	...
	function steamworks.inventory.DeserializeResult(pOutResultHandle, pBuffer, unBufferSize, bRESERVED_MUST_BE_FALSE)
		return lib.SteamAPI_ISteamInventory_DeserializeResult(
			steamworks.inventory_ptr,
			pOutResultHandle,
			pBuffer,
			unBufferSize,
	...
	function steamworks.inventory.GenerateItems(pResultHandle, pArrayItemDefs, punArrayQuantity, unArrayLength)
		return lib.SteamAPI_ISteamInventory_GenerateItems(
			steamworks.inventory_ptr,
			pResultHandle,
			pArrayItemDefs,
			punArrayQuantity,
	...
	function steamworks.inventory.AddPromoItems(pResultHandle, pArrayItemDefs, unArrayLength)
		return lib.SteamAPI_ISteamInventory_AddPromoItems(
			steamworks.inventory_ptr,
			pResultHandle,
			pArrayItemDefs,
			unArrayLength
	...
	function steamworks.inventory.ConsumeItem(pResultHandle, itemConsume, unQuantity)
		return lib.SteamAPI_ISteamInventory_ConsumeItem(
			steamworks.inventory_ptr,
			pResultHandle,
			itemConsume,
			unQuantity
	...
	function steamworks.inventory.TransferItemQuantity(pResultHandle, itemIdSource, unQuantity, itemIdDest)
		return lib.SteamAPI_ISteamInventory_TransferItemQuantity(
			steamworks.inventory_ptr,
			pResultHandle,
			itemIdSource,
			unQuantity,
	...
	function steamworks.inventory.GetItemDefinitionIDs(pItemDefIDs, punItemDefIDsArraySize)
		return lib.SteamAPI_ISteamInventory_GetItemDefinitionIDs(
			steamworks.inventory_ptr,
			pItemDefIDs,
			punItemDefIDsArraySize
		)
	end
	function steamworks.inventory.GetItemDefinitionProperty(
		iDefinition,
		pchPropertyName,
		pchValueBuffer,
		punValueBufferSizeOut
	...
	function steamworks.inventory.GetEligiblePromoItemDefinitionIDs(steamID, pItemDefIDs, punItemDefIDsArraySize)
		return lib.SteamAPI_ISteamInventory_GetEligiblePromoItemDefinitionIDs(
			steamworks.inventory_ptr,
			steamID,
			pItemDefIDs,
			punItemDefIDsArraySize
...
if steamworks.musicremote_ptr == nil then
	...
	function steamworks.musicremote.UpdateCurrentEntryCoverArt(pvBuffer, cbBufferLength)
		return lib.SteamAPI_ISteamMusicRemote_UpdateCurrentEntryCoverArt(
			steamworks.musicremote_ptr,
			pvBuffer,
			cbBufferLength
		)
	end
...
if steamworks.http_ptr == nil then
	...
	function steamworks.http.SetHTTPRequestNetworkActivityTimeout(hRequest, unTimeoutSeconds)
		return lib.SteamAPI_ISteamHTTP_SetHTTPRequestNetworkActivityTimeout(
			steamworks.http_ptr,
			hRequest,
			unTimeoutSeconds
		)
	...
	function steamworks.http.SetHTTPRequestHeaderValue(hRequest, pchHeaderName, pchHeaderValue)
		return lib.SteamAPI_ISteamHTTP_SetHTTPRequestHeaderValue(
			steamworks.http_ptr,
			hRequest,
			pchHeaderName,
			pchHeaderValue
	...
	function steamworks.http.SetHTTPRequestGetOrPostParameter(hRequest, pchParamName, pchParamValue)
		return lib.SteamAPI_ISteamHTTP_SetHTTPRequestGetOrPostParameter(
			steamworks.http_ptr,
			hRequest,
			pchParamName,
			pchParamValue
	...
	function steamworks.http.GetHTTPResponseHeaderSize(hRequest, pchHeaderName, unResponseHeaderSize)
		return lib.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderSize(
			steamworks.http_ptr,
			hRequest,
			pchHeaderName,
	...
	function steamworks.http.GetHTTPResponseHeaderValue(hRequest, pchHeaderName, pHeaderValueBuffer, unBufferSize)
		return lib.SteamAPI_ISteamHTTP_GetHTTPResponseHeaderValue(
			steamworks.http_ptr,
			hRequest,
			pchHeaderName,
			pHeaderValueBuffer,
	...
	function steamworks.http.GetHTTPResponseBodyData(hRequest, pBodyDataBuffer, unBufferSize)
		return lib.SteamAPI_ISteamHTTP_GetHTTPResponseBodyData(
			steamworks.http_ptr,
			hRequest,
			pBodyDataBuffer,
			unBufferSize
	...
	function steamworks.http.GetHTTPStreamingResponseBodyData(hRequest, cOffset, pBodyDataBuffer, unBufferSize)
		return lib.SteamAPI_ISteamHTTP_GetHTTPStreamingResponseBodyData(
			steamworks.http_ptr,
			hRequest,
			cOffset,
			pBodyDataBuffer,
	...
	function steamworks.http.SetHTTPRequestRawPostBody(hRequest, pchContentType, pubBody, unBodyLen)
		return lib.SteamAPI_ISteamHTTP_SetHTTPRequestRawPostBody(
			steamworks.http_ptr,
			hRequest,
			pchContentType,
			pubBody,
	...
	function steamworks.http.SetHTTPRequestRequiresVerifiedCertificate(hRequest, bRequireVerifiedCertificate)
		return lib.SteamAPI_ISteamHTTP_SetHTTPRequestRequiresVerifiedCertificate(
			steamworks.http_ptr,
			hRequest,
...
steamworks.utils_ptr =
	lib.SteamAPI_ISteamClient_GetISteamUtils(steamworks.client_ptr, steamworks.pipe_ptr, "SteamUtils009")
if steamworks.utils_ptr == nil then
	...
	function steamworks.utils.GetAPICallResult(hSteamAPICall, pCallback, cubCallback, iCallbackExpected, pbFailed)
		return lib.SteamAPI_ISteamUtils_GetAPICallResult(
			steamworks.utils_ptr,
			hSteamAPICall,
			pCallback,
			cubCallback,
	...
	function steamworks.utils.ShowGamepadTextInput(
		eInputMode,
		eLineInputMode,
		pchDescription,
		unCharMax,
	...
	function steamworks.utils.SetOverlayNotificationInset(nHorizontalInset, nVerticalInset)
		return lib.SteamAPI_ISteamUtils_SetOverlayNotificationInset(
			steamworks.utils_ptr,
			nHorizontalInset,
			nVerticalInset
		)
...
if steamworks.remotestorage_ptr == nil then
	...
	function steamworks.remotestorage.FileReadAsyncComplete(hReadCall, pvBuffer, cubToRead)
		return lib.SteamAPI_ISteamRemoteStorage_FileReadAsyncComplete(
	...
	function steamworks.remotestorage.SetSyncPlatforms(pchFile, eRemoteStoragePlatform)
		return lib.SteamAPI_ISteamRemoteStorage_SetSyncPlatforms(
			steamworks.remotestorage_ptr,
			pchFile,
	...
	function steamworks.remotestorage.FileWriteStreamWriteChunk(writeHandle, pvData, cubData)
		return lib.SteamAPI_ISteamRemoteStorage_FileWriteStreamWriteChunk(
			steamworks.remotestorage_ptr,
			writeHandle,
			pvData,
			cubData
	...
	function steamworks.remotestorage.GetFileNameAndSize(iFile, pnFileSizeInBytes)
		local str =
			lib.SteamAPI_ISteamRemoteStorage_GetFileNameAndSize(steamworks.remotestorage_ptr, iFile, pnFileSizeInBytes)
		if str ~= nil then
			return ffi.string(str)
		end
	end
	...
	function steamworks.remotestorage.GetUGCDownloadProgress(hContent, pnBytesDownloaded, pnBytesExpected)
		return lib.SteamAPI_ISteamRemoteStorage_GetUGCDownloadProgress(
			steamworks.remotestorage_ptr,
			hContent,
			pnBytesDownloaded,
			pnBytesExpected
	...
	function steamworks.remotestorage.GetUGCDetails(hContent, pnAppID, ppchName, pnFileSizeInBytes, pSteamIDOwner)
		return lib.SteamAPI_ISteamRemoteStorage_GetUGCDetails(
			steamworks.remotestorage_ptr,
			hContent,
			pnAppID,
			ppchName,
	...
	function steamworks.remotestorage.UGCRead(hContent, pvData, cubDataToRead, cOffset, eAction)
		return lib.SteamAPI_ISteamRemoteStorage_UGCRead(
			steamworks.remotestorage_ptr,
			hContent,
			pvData,
			cubDataToRead,
	...
	function steamworks.remotestorage.CreatePublishedFileUpdateRequest(unPublishedFileId)
		return lib.SteamAPI_ISteamRemoteStorage_CreatePublishedFileUpdateRequest(
			steamworks.remotestorage_ptr,
			unPublishedFileId
		)
	end
	function steamworks.remotestorage.UpdatePublishedFileFile(updateHandle, pchFile)
		return lib.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileFile(
			steamworks.remotestorage_ptr,
			updateHandle,
			pchFile
		)
	...
	function steamworks.remotestorage.UpdatePublishedFilePreviewFile(updateHandle, pchPreviewFile)
		return lib.SteamAPI_ISteamRemoteStorage_UpdatePublishedFilePreviewFile(
			steamworks.remotestorage_ptr,
			updateHandle,
			pchPreviewFile
		)
	...
	function steamworks.remotestorage.UpdatePublishedFileTitle(updateHandle, pchTitle)
		return lib.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTitle(
			steamworks.remotestorage_ptr,
			updateHandle,
			pchTitle
		)
	...
	function steamworks.remotestorage.UpdatePublishedFileDescription(updateHandle, pchDescription)
		return lib.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileDescription(
			steamworks.remotestorage_ptr,
			updateHandle,
			pchDescription
		)
	...
	function steamworks.remotestorage.UpdatePublishedFileVisibility(updateHandle, eVisibility)
		return lib.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileVisibility(
			steamworks.remotestorage_ptr,
			updateHandle,
			eVisibility
		)
	...
	function steamworks.remotestorage.UpdatePublishedFileTags(updateHandle, pTags)
		return lib.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileTags(
			steamworks.remotestorage_ptr,
			updateHandle,
			pTags
		)
	...
	function steamworks.remotestorage.GetPublishedFileDetails(unPublishedFileId, unMaxSecondsOld)
		return lib.SteamAPI_ISteamRemoteStorage_GetPublishedFileDetails(
			steamworks.remotestorage_ptr,
			unPublishedFileId,
			unMaxSecondsOld
		)
	...
	function steamworks.remotestorage.UnsubscribePublishedFile(unPublishedFileId)
		return lib.SteamAPI_ISteamRemoteStorage_UnsubscribePublishedFile(
			steamworks.remotestorage_ptr,
			unPublishedFileId
		)
	end
	function steamworks.remotestorage.UpdatePublishedFileSetChangeDescription(updateHandle, pchChangeDescription)
		return lib.SteamAPI_ISteamRemoteStorage_UpdatePublishedFileSetChangeDescription(
			steamworks.remotestorage_ptr,
			updateHandle,
	...
	function steamworks.remotestorage.GetPublishedItemVoteDetails(unPublishedFileId)
		return lib.SteamAPI_ISteamRemoteStorage_GetPublishedItemVoteDetails(
			steamworks.remotestorage_ptr,
			unPublishedFileId
		)
	end
	function steamworks.remotestorage.UpdateUserPublishedItemVote(unPublishedFileId, bVoteUp)
		return lib.SteamAPI_ISteamRemoteStorage_UpdateUserPublishedItemVote(
			steamworks.remotestorage_ptr,
			unPublishedFileId,
			bVoteUp
		)
	...
	function steamworks.remotestorage.GetUserPublishedItemVoteDetails(unPublishedFileId)
		return lib.SteamAPI_ISteamRemoteStorage_GetUserPublishedItemVoteDetails(
			steamworks.remotestorage_ptr,
			unPublishedFileId
		)
	end
	function steamworks.remotestorage.EnumerateUserSharedWorkshopFiles(
		steamId,
		unStartIndex,
		pRequiredTags,
		pExcludedTags
	)
		return lib.SteamAPI_ISteamRemoteStorage_EnumerateUserSharedWorkshopFiles(
			steamworks.remotestorage_ptr,
			steamId,
			unStartIndex,
			pRequiredTags,
	...
	function steamworks.remotestorage.SetUserPublishedFileAction(unPublishedFileId, eAction)
		return lib.SteamAPI_ISteamRemoteStorage_SetUserPublishedFileAction(
			steamworks.remotestorage_ptr,
			unPublishedFileId,
			eAction
		)
	...
	function steamworks.remotestorage.EnumeratePublishedFilesByUserAction(eAction, unStartIndex)
		return lib.SteamAPI_ISteamRemoteStorage_EnumeratePublishedFilesByUserAction(
			steamworks.remotestorage_ptr,
			eAction,
			unStartIndex
		)
	end
	function steamworks.remotestorage.EnumeratePublishedWorkshopFiles(
		eEnumerationType,
		unStartIndex,
		unCount,
		unDays,
	...
	function steamworks.remotestorage.UGCDownloadToLocation(hContent, pchLocation, unPriority)
		return lib.SteamAPI_ISteamRemoteStorage_UGCDownloadToLocation(
			steamworks.remotestorage_ptr,
			hContent,
			pchLocation,
			unPriority
...
if steamworks.matchmaking_ptr == nil then
	...
	function steamworks.matchmaking.AddFavoriteGame(
		nAppID,
		nIP,
		nConnPort,
		nQueryPort,
	...
	function steamworks.matchmaking.RemoveFavoriteGame(nAppID, nIP, nConnPort, nQueryPort, unFlags)
		return lib.SteamAPI_ISteamMatchmaking_RemoveFavoriteGame(
			steamworks.matchmaking_ptr,
			nAppID,
			nIP,
			nConnPort,
	...
	function steamworks.matchmaking.AddRequestLobbyListStringFilter(pchKeyToMatch, pchValueToMatch, eComparisonType)
		return lib.SteamAPI_ISteamMatchmaking_AddRequestLobbyListStringFilter(
			steamworks.matchmaking_ptr,
			pchKeyToMatch,
			pchValueToMatch,
			eComparisonType
	...
	function steamworks.matchmaking.AddRequestLobbyListNumericalFilter(pchKeyToMatch, nValueToMatch, eComparisonType)
		return lib.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNumericalFilter(
			steamworks.matchmaking_ptr,
			pchKeyToMatch,
			nValueToMatch,
			eComparisonType
	...
	function steamworks.matchmaking.AddRequestLobbyListNearValueFilter(pchKeyToMatch, nValueToBeCloseTo)
		return lib.SteamAPI_ISteamMatchmaking_AddRequestLobbyListNearValueFilter(
			steamworks.matchmaking_ptr,
			pchKeyToMatch,
			nValueToBeCloseTo
		)
	...
	function steamworks.matchmaking.AddRequestLobbyListFilterSlotsAvailable(nSlotsAvailable)
		return lib.SteamAPI_ISteamMatchmaking_AddRequestLobbyListFilterSlotsAvailable(
			steamworks.matchmaking_ptr,
			nSlotsAvailable
		)
	end
	function steamworks.matchmaking.AddRequestLobbyListDistanceFilter(eLobbyDistanceFilter)
		return lib.SteamAPI_ISteamMatchmaking_AddRequestLobbyListDistanceFilter(
			steamworks.matchmaking_ptr,
			eLobbyDistanceFilter
		)
	end
	function steamworks.matchmaking.AddRequestLobbyListResultCountFilter(cMaxResults)
		return lib.SteamAPI_ISteamMatchmaking_AddRequestLobbyListResultCountFilter(
			steamworks.matchmaking_ptr,
			cMaxResults
		)
	end
	function steamworks.matchmaking.AddRequestLobbyListCompatibleMembersFilter(steamIDLobby)
		return lib.SteamAPI_ISteamMatchmaking_AddRequestLobbyListCompatibleMembersFilter(
			steamworks.matchmaking_ptr,
			steamIDLobby
		)
	end
	...
	function steamworks.matchmaking.InviteUserToLobby(steamIDLobby, steamIDInvitee)
		return lib.SteamAPI_ISteamMatchmaking_InviteUserToLobby(
			steamworks.matchmaking_ptr,
			steamIDLobby,
			steamIDInvitee
		)
	...
	function steamworks.matchmaking.GetLobbyDataByIndex(
		steamIDLobby,
		iLobbyData,
		pchKey,
		cchKeyBufferSize,
	...
	function steamworks.matchmaking.GetLobbyMemberData(steamIDLobby, steamIDUser, pchKey)
		local str = lib.SteamAPI_ISteamMatchmaking_GetLobbyMemberData(
			steamworks.matchmaking_ptr,
			steamIDLobby,
			steamIDUser,
			pchKey
	...
	function steamworks.matchmaking.SetLobbyMemberData(steamIDLobby, pchKey, pchValue)
		return lib.SteamAPI_ISteamMatchmaking_SetLobbyMemberData(
			steamworks.matchmaking_ptr,
			steamIDLobby,
			pchKey,
			pchValue
	...
	function steamworks.matchmaking.SendLobbyChatMsg(steamIDLobby, pvMsgBody, cubMsgBody)
		return lib.SteamAPI_ISteamMatchmaking_SendLobbyChatMsg(
			steamworks.matchmaking_ptr,
			steamIDLobby,
			pvMsgBody,
			cubMsgBody
	...
	function steamworks.matchmaking.GetLobbyChatEntry(
		steamIDLobby,
		iChatID,
		pSteamIDUser,
		pvData,
	...
	function steamworks.matchmaking.SetLobbyGameServer(
		steamIDLobby,
		unGameServerIP,
		unGameServerPort,
		steamIDGameServer
	...
	function steamworks.matchmaking.GetLobbyGameServer(
		steamIDLobby,
		punGameServerIP,
		punGameServerPort,
		psteamIDGameServer
	...
	function steamworks.matchmaking.SetLinkedLobby(steamIDLobby, steamIDLobbyDependent)
		return lib.SteamAPI_ISteamMatchmaking_SetLinkedLobby(
			steamworks.matchmaking_ptr,
			steamIDLobby,
...
do
	...
	function steamworks.client.GetISteamMatchmakingServers(hSteamUser, hSteamPipe, pchVersion)
		return lib.SteamAPI_ISteamClient_GetISteamMatchmakingServers(
			steamworks.client_ptr,
			hSteamUser,
			hSteamPipe,
			pchVersion
	...
	function steamworks.client.GetISteamGenericInterface(hSteamUser, hSteamPipe, pchVersion)
		return lib.SteamAPI_ISteamClient_GetISteamGenericInterface(
			steamworks.client_ptr,
			hSteamUser,
			hSteamPipe,
			pchVersion
	...
	function steamworks.client.GetISteamGameServerStats(hSteamuser, hSteamPipe, pchVersion)
		return lib.SteamAPI_ISteamClient_GetISteamGameServerStats(
			steamworks.client_ptr,
			hSteamuser,
			hSteamPipe,
			pchVersion
	...
	function steamworks.client.GetISteamRemoteStorage(hSteamuser, hSteamPipe, pchVersion)
		return lib.SteamAPI_ISteamClient_GetISteamRemoteStorage(
			steamworks.client_ptr,
			hSteamuser,
			hSteamPipe,
			pchVersion
	...
	function steamworks.client.GetISteamUnifiedMessages(hSteamuser, hSteamPipe, pchVersion)
		return lib.SteamAPI_ISteamClient_GetISteamUnifiedMessages(
			steamworks.client_ptr,
			hSteamuser,
			hSteamPipe,
			pchVersion
...
steamworks.user = {}
steamworks.user_ptr = lib.SteamAPI_ISteamClient_GetISteamUser(
	steamworks.client_ptr,
	steamworks.steam_user_ptr,
	steamworks.pipe_ptr,
	"SteamUser019"
...
if steamworks.user_ptr == nil then
	...
	function steamworks.user.InitiateGameConnection(
		pAuthBlob,
		cbMaxAuthBlob,
		steamIDGameServer,
		unIPServer,
...
function META:GetClanChatMessage(iMessage, prgchText, cchTextMax, peChatEntryType, psteamidChatter)
	return steamworks.friends.GetClanChatMessage(
		self.id,
		iMessage,
		prgchText,
		cchTextMax,
...
function META:EnumerateSharedWorkshopFiles(unStartIndex, pRequiredTags, pExcludedTags)
	return steamworks.remotestorage.EnumerateUserSharedWorkshopFiles(
		self.id,
		unStartIndex,
		pRequiredTags,
		pExcludedTags
...
function META:GetLobbyDataByIndex(iLobbyData, pchKey, cchKeyBufferSize, pchValue, cchValueBufferSize)
	return steamworks.matchmaking.GetLobbyDataByIndex(
		self.id,
		iLobbyData,
		pchKey,
		cchKeyBufferSize,
